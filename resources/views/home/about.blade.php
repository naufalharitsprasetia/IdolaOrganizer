...
@section('content')
    ...
    <section id="about" class="md:pt-24 md:pb-28 w-full bg-third">
        <div class="container mx-auto">
            <div class="flex flex-col-reverse md:flex-row">
                <div class="w-3/4 mb-8 md:mb-0 md:px-10 md:w-1/2 mx-auto" data-aos="fade-up-left">
                ...
                <div class="my-5 md:my-0 md:px-10 w-1/2 mx-auto flex justify-center items-center " data-aos="fade-up-right">
    ...
    <div class="bg-white">
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            <h2 class="text-2xl font-bold tracking-tight text-gray-900 text-center underline" data-aos="zoom-in-up">Our Team
            </h2>

            <div class="mt-6 grid grid-cols-3 gap-x-6 gap-y-10 sm:grid-cols-3 lg:grid-cols-3 xl:gap-x-8">
                {{-- 1 --}}
                <div class="group relative" data-aos="zoom-in-up">
                    <div
                ...
                <div class="group relative" data-aos="zoom-in-up">
                    <div
                        class="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                        <img src="/img/colab-4.jpg" alt="Front of men&#039;s Basic Tee in black."
                            class="h-full w-full object-cover object-center lg:h-full lg:w-full">
                    </div>
                    <div class="mt-4 flex flex-col">
                        <div>
    ...
    <div class="bg-fourth py-20 sm:py-24">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 class="text-center text-lg font-semibold leading-8 text-gray-900" data-aos="flip-up">Project dibangun dengan
                teknologi :</h2>
            <div
